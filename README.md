...
* **务必替换所有的`0b73caa7-8ca0-4492-9aa6-f79402f0c8bf`为部署时设置的UUID,建议更改,不要每个人都一样**  
...
* 端口：443
* 默认UUID：0b73caa7-8ca0-4492-9aa6-f79402f0c8bf
* vmess额外id：0
* 加密：none
* 传输协议：ws
* 伪装类型：none
* 伪装域名：xxx.workers.dev(CF Workers反代地址)
* 路径：/0b73caa7-8ca0-4492-9aa6-f79402f0c8bf-vless // 默认vless使用(/自定义UUID码-vless)，vmess使用(/自定义UUID码-vmess)
* 底层传输安全：tls
* 跳过证书验证：false
```
</details>
...
* 客户端下载: https://github.com/p4gefau1t/trojan-go/releases
{
    ...
    "remote_port": 443,
    "password": [
        "0b73caa7-8ca0-4492-9aa6-f79402f0c8bf"
    ],
    "websocket": {
        "enabled": true,
        "path": "/0b73caa7-8ca0-4492-9aa6-f79402f0c8bf-trojan",
...
* 端口: 443
* 密码：0b73caa7-8ca0-4492-9aa6-f79402f0c8bf
* 加密：chacha20-ietf-poly1305
* 插件程序：xray-plugin_windows_amd64.exe  //需将插件https://github.com/shadowsocks/xray-plugin/releases下载解压后放至shadowsocks同目录
* 插件选项: tls;host=xxx.herokuapp.com;path=/0b73caa7-8ca0-4492-9aa6-f79402f0c8bf-ss
```
</details>
